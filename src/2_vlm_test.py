...
#bilgayar kapasitesine göre base ya da large model seçilebilir. Large model daha iyi performans verir ancak daha fazla bellek kullanır.
...
image_path = os.path.join(PROJECT_ROOT, "dataset", "afisler", "afis_200.png")
...
if not os.path.exists(image_path):
    ...
    print("\n" + "=" * 50)
    print("🔍 TEST EDİLEN GÖRSEL: afis_200.png")
    print("=" * 50)
    ...
    orijinal_veri = df.iloc[0].to_dict()
